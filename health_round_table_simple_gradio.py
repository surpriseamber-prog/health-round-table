...
def get_pubmed_query(agent_key, case_text):
    ...
    queries = {
        ...
        "longevity": "creatine supplementation elderly muscle loss BPC-157 peptide therapy cognitive decline longevity 2025",
